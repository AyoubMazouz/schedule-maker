...
import { GiClockwork, GiCombinationLock } from "react-icons/gi";
...
export const IcPaste = HiOutlineClipboardDocumentCheck;
...
export const IcReset = HiArrowPath;
export const IcPuzzle = HiOutlinePuzzlePiece;
export const IcClock = GiClockwork;
export const IcOpenSource = GiCombinationLock;
