...
const EditorNavBar = () => {
	...
	const ShowSessionsMenuItem = () => (
		<div className="menu-item">
			<input type="checkbox" checked={view.sessions} onChange={handleShowSessions} />
			show sessions
		</div>
	);
	...
	return (
		<div className="sticky top-0 z-30 col-span-full flex h-12 justify-between gap-x-2 border-b border-dark/50 shadow-lg">
			<div className="flex h-full items-center">
				...
				<DropdownMenu
					...
					options={[
						...
						["reset zoom", handleResetZoom, IcReset, view.zoom === Math.floor(ZOOM.length / 2)],
				...
				{selectedCell ? (
					<>
						<Select
							...
							value={data[selectedCell[0]].schedule[selectedCell[1]][selectedCell[2]][0]}
						...
						<Select
							label="modules"
							values={modules}
							value={data[selectedCell[0]].schedule[selectedCell[1]][selectedCell[2]][1]}
						...
						<Select
							...
							value={data[selectedCell[0]].schedule[selectedCell[1]][selectedCell[2]][2]}
						...
						<Select
							label="events"
							values={events}
							value={data[selectedCell[0]].schedule[selectedCell[1]][selectedCell[2]][3]}
