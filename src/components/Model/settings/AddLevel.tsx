...
const AddLevel = () => {
  ...
  const removeModuleHandler = (value: string) => {
    const newModules = modules.filter((mod) => mod !== value);
  ...
  return (
    <>
      <div className="space-y-6">
        <div className="text-xl text-center text-primary">Add New Level</div>
        <div className="flex flex-col items-center gap-2">
          ...
          <input
            ...
            name="level"
            value={levelInput}
            onChange={(e) => setLevelInput(e.target.value.toUpperCase())}
          />
        </div>
        <div className="flex flex-col items-center gap-2">
        ...
        <div className="textbox">
          ...
          <input
            ...
            value={moduleInput}
            onChange={(e) => setModuleInput(e.target.value.toUpperCase())}
